...
class Model(nn.Module):
    def __init__(self, vocabulary_size, embedding_size, output_size, minibatch_size, device):
    ...
    def forward(self, session, hidden):
        ...
        x = embedding.view(embedding.shape[1], self.minibatch_size, -1) # according to pytorch api lstm input format: (seq len, minibatch size, features) 
